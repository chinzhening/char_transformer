...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{assets/final_model_loss_accuracy.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{assets/final_model_additional_train_results.png}
